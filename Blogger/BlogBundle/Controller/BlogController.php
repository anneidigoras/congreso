...
return $this->render('BloggerBlogBundle:Blog:show.html.twig', array('post' => $post, 'comments' => $comments, 'tags' => $tags));
...
public function inicioAction()
{
	...
	public function SobreMiAction()
{
	return $this->render('BloggerBlogBundle:Blog:sobremi.html.twig');
}
